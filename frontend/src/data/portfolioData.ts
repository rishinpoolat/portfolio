...
export const projects: Project[] = [
  {
    ...
    shortDescription: 'AI-powered CLI tool for generating conventional commit messages',
    fullDescription: 'Intelligent CLI tool that revolutionizes git workflow by automatically generating conventional commit messages using AI. Supports multiple AI providers with automatic failover.',
    ...
    techStack: [
      ...
      { category: 'AI Providers', technologies: ['Groq', 'OpenAI', 'Anthropic', 'Google Gemini'] },
      { category: 'Libraries', technologies: ['inquirer.js', 'chalk', 'axios'] }
    ],
    features: [
      {
        title: 'Multi-Provider AI Support',
        description: 'Support for multiple AI providers with automatic failover',
        details: ['Groq (recommended)', 'OpenAI', 'Anthropic Claude', 'Google Gemini']
      },
      {
        title: 'Intelligent Workflow Modes',
        description: 'Auto and interactive modes for different use cases',
        details: ['Auto Mode (default)', 'Interactive Mode (-i flag)', 'Custom message options']
      }
    ],
    achievements: [
    ...
    challenges: ['Multi-provider integration', 'Git diff parsing', 'Error handling'],
    solutions: ['Unified AI interface', 'Robust parsing logic', 'Comprehensive error recovery'],
    learnings: ['AI integration patterns', 'CLI tool development', 'Package distribution'],
    category: 'cli-tool',
    complexity: 'advanced',
    status: 'completed'
  },
  ...
  },
  {
    ...
    description: 'Developed video summarization REST API with multi-LLM orchestration and n8n workflow integration, featuring intelligent failover and advanced chunking algorithms, attaining 95% transcript accuracy and decreased content consumption time by 85%.',
    techStack: ['TypeScript', 'Hono', 'LLM', 'REST API', 'Puppeteer', 'N8N'],
    githubUrl: 'https://github.com/rishinpoolat/video-summarizer',
    fullDescription: 'Video Summarizer is a sophisticated REST API that transforms lengthy video content into concise, actionable summaries. Using advanced AI orchestration and intelligent chunking algorithms, it processes video transcripts and generates comprehensive summaries.',
    features: [
      'Multi-LLM orchestration with intelligent failover',
      'Advanced transcript chunking algorithms',
      'RESTful API with Hono framework',
      'N8N workflow integration',
      'Web scraping with Puppeteer for video metadata',
      'Customizable summary lengths and formats',
    ...
    achievements: [
      '95% transcript accuracy maintained',
      '85% reduction in content consumption time',
      'Scalable architecture handling multiple concurrent requests',
  ...
  },
  {
    ...
    description: 'Engineered hybrid automated essay scoring system combining DeBERTa ensemble with LightGBM feature models and calibration techniques, achieving 0.8358 QWK on 24,728 essays with comprehensive feedback generation and responsive web dashboard.',
    techStack: ['Python', 'NLP', 'DeBERTa', 'Machine Learning', 'FastAPI', 'LightGBM'],
    githubUrl: 'https://github.com/rishinpoolat/automated-essay-scoring',
    fullDescription: 'Advanced automated essay scoring system that combines state-of-the-art NLP models with traditional ML approaches to provide accurate essay assessments and detailed feedback.',
    features: [
  ...
  },
  {
    ...
    description: 'Built intelligent developer project recommendation platform using Next.js and Google Gemini AI, featuring hybrid search with PostgreSQL full-text search and AI-generated suggestions. Delivers personalized project ideas with detailed implementation steps, tech stacks, and learning outcomes based on user prompts.',
    techStack: ['Next.js', 'TypeScript', 'Google Gemini AI', 'Supabase', 'PostgreSQL', 'Tailwind CSS', 'Radix UI'],
    githubUrl: 'https://github.com/rishinpoolat/idea-solution-frontend',
    fullDescription: 'An intelligent platform that helps developers discover and plan their next projects using AI-powered recommendations and comprehensive project analysis.',
    features: [
  ...
  },
  {
    id: 'penply',
    title: 'Penply',
    description: 'Built unified collaborative study platform consolidating real-time chat, note sharing, file management, event scheduling, and calendar functionality into single interface, eliminating context switching by 75% with scalable architecture and cloud deployment.',
    techStack: ['JavaScript', 'React', 'TailwindCSS', 'Node.js', 'Express.js', 'AWS', 'EC2', 'DynamoDB', 'RDS', 'S3'],
    liveUrl: 'http://www.penply.com',
    fullDescription: 'Penply is a comprehensive collaborative study platform that brings together all essential student tools in one unified interface, reducing the need for context switching between multiple applications.',
    features: [
  ...
  },
  {
    ...
    description: 'Developed a CNN model for detecting whether riders wearing helmets or not. The model was then integrated into a Raspberry Pi, camera, and speaker. The integration enabled real-time monitoring of helmet usage, with the camera capturing visual data, the ML model analyzing it, and the speaker providing immediate feedback based on the detection results.',
    techStack: ['Python', 'TensorFlow', 'Keras', 'OpenCV', 'Numpy', 'Pandas', 'MobileNetV2', 'Raspberry Pi'],
    githubUrl: 'https://github.com/rishinpoolat/realtime-helmet-detector',
    fullDescription: 'A computer vision system designed for traffic safety monitoring, using deep learning to detect helmet usage in real-time with immediate audio feedback.',
    features: [
  ...
  },
  {
    id: 'from-home',
    title: 'From Home',
    description: 'The Full-Stack E-commerce web application is specifically designed to cater to the needs of home bakers, providing them with a platform where they can easily showcase and sell their delicious homemade products online, thereby bridging the gap between baking enthusiasts and potential customers.',
    techStack: ['React.js', 'Node.js', 'Express', 'MongoDB'],
    githubUrl: 'https://github.com/rishinpoolat/from-home',
    fullDescription: 'A specialized e-commerce platform designed to empower home bakers by providing them with professional tools to showcase and sell their homemade products online.',
    features: [
  ...
  },
  {
    id: 'wise-wallet',
    title: 'Wise Wallet',
    description: 'Receipt analysis application that extracts text from user-uploaded receipts using OCR technology, leveraging a fine-tuned AI model to provide personalized suggestions and feedback.',
    techStack: ['React.js', 'Tailwind', 'Cloud Firestore', 'Firebase', 'OCR', 'AI/ML'],
    liveUrl: 'https://wisewallet-app.vercel.app/',
    fullDescription: 'Wise Wallet is an intelligent receipt analysis application that helps users track their spending patterns and provides personalized financial insights using OCR and AI technologies.',
    features: [
  ...
  },
  {
    id: 'social-app',
    title: 'Social App',
    description: 'The social media application provides users with the ability to follow their favorite accounts, share their thoughts through creating posts, express appreciation by liking content, and engage in discussions by commenting on posts shared within the platform.',
    techStack: ['Node.js', 'Express', 'PostgreSQL', 'EJS'],
    githubUrl: 'https://github.com/rishinpoolat/socialapp',
    fullDescription: 'A full-featured social media platform built with server-side rendering, providing users with essential social networking capabilities in a clean, responsive interface.',
    features: [
      'User authentication and profiles',
    ...
    challenges: [
      'Implementing complex social media features',
    ...
    achievements: [
      ...
      'Efficient server-side rendering implementation'
    ]
  }
];
...
export const certificationData: Certification[] = [
  {
    ...
    description: 'Earned the AWS Certified Cloud Practitioner certification, which validates my understanding of AWS Cloud concepts, services, and terminology.',
    issuer: 'Amazon Web Services (AWS)',
    badgeUrl: 'https://www.credly.com/badges/625f06e2-9e95-4c65-8178-9296e4ba2f71/public_url',
...
export const hackathonData: Hackathon[] = [
  {
    ...
    project: 'Wise Wallet',
    description: 'Designed and engineered an innovative receipt analysis application that extracts text from user-uploaded receipts using OCR technology, leveraging a fine-tuned AI model to provide personalized suggestions and feedback.',
    issuer: 'IBM',
    badgeUrl: 'https://www.credly.com/badges/8ff75b39-37e4-44ff-b677-28c4b79f3795/public_url',
